...
update_manifests_file_version() {
    ...
    update_images=("openconsole" "kubeblocks-console" "apiserver" "cubetran-front" "cr4w" "kubeblocks-installer" "dms" "servicemirror" "kb-cloud-hook" "kb-cloud-docs" "apecloud-addon-charts")
